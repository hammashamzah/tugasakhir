...
#include "../integrasi/datalogger.h"
...
QT_MOC_LITERAL(3, 16, 13), // "QList<Player>"
QT_MOC_LITERAL(4, 30, 9) // "newPlayer"

    },
    "DataLogger\0add\0\0QList<Player>\0newPlayer"
};
...
void DataLogger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->add((*reinterpret_cast< QList<Player>(*)>(_a[1]))); break;
        default: ;
        }
    }
}
