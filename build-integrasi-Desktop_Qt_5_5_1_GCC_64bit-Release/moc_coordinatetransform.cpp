...
QT_MOC_LITERAL(4, 58, 23), // "sendTransformedPosition"
QT_MOC_LITERAL(5, 82, 23), // "QVector<QList<Player> >"
QT_MOC_LITERAL(6, 106, 20), // "sendPlayerIdAssigned"
QT_MOC_LITERAL(7, 127, 18), // "setTransformMatrix"
QT_MOC_LITERAL(8, 146, 23), // "QVector<QList<QPoint> >"
QT_MOC_LITERAL(9, 170, 25), // "transformationCoordinates"
QT_MOC_LITERAL(10, 196, 12), // "setImageSize"
QT_MOC_LITERAL(11, 209, 12), // "QList<QSize>"
QT_MOC_LITERAL(12, 222, 24), // "processTransformPosition"
QT_MOC_LITERAL(13, 247, 20) // "returnAssignedPlayer"

    },
    "CoordinateTransform\0sendTransformedRawData\0"
    "\0QList<Player>\0sendTransformedPosition\0"
    "QVector<QList<Player> >\0sendPlayerIdAssigned\0"
...
void CoordinateTransform::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendTransformedPosition((*reinterpret_cast< QVector<QList<Player> >(*)>(_a[1]))); break;
        case 2: _t->sendPlayerIdAssigned((*reinterpret_cast< QVector<QList<Player> >(*)>(_a[1]))); break;
        case 3: _t->setTransformMatrix((*reinterpret_cast< QVector<QList<QPoint> >(*)>(_a[1]))); break;
        case 4: _t->setImageSize((*reinterpret_cast< QList<QSize>(*)>(_a[1]))); break;
        case 5: _t->processTransformPosition((*reinterpret_cast< QVector<QList<Player> >(*)>(_a[1]))); break;
        case 6: _t->returnAssignedPlayer((*reinterpret_cast< QVector<QList<Player> >(*)>(_a[1]))); break;
        default: ;
        }
...
// SIGNAL 2
void CoordinateTransform::sendPlayerIdAssigned(QVector<QList<Player> > _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
