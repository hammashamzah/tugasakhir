...
#include "../lulusjuni/videoprocessor.h"
...
QT_MOC_LITERAL(4, 57, 17), // "setValueParameter"
QT_MOC_LITERAL(5, 75, 12), // "QVector<int>"
QT_MOC_LITERAL(6, 88, 17), // "getMaskCoordinate"
QT_MOC_LITERAL(7, 106, 13) // "QList<QPoint>"

    },
    "VideoProcessor\0setSingleCameraViewImage\0"
    "\0QVector<QImage>\0setValueParameter\0"
...
void VideoProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setValueParameter((*reinterpret_cast< QVector<int>(*)>(_a[1]))); break;
        case 2: _t->getMaskCoordinate((*reinterpret_cast< QList<QPoint>(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject VideoProcessor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoProcessor.data,
