...
QT_MOC_LITERAL(4, 65, 23), // "setTrapeziumCoordinates"
...
QT_MOC_LITERAL(9, 127, 8), // "setFrame"
QT_MOC_LITERAL(10, 136, 15), // "QVector<QImage>"
QT_MOC_LITERAL(11, 152, 40), // "on_cameraSelectCombo_currentI..."
QT_MOC_LITERAL(12, 193, 5), // "index"
QT_MOC_LITERAL(13, 199, 26), // "on_pushButton_set_released"
QT_MOC_LITERAL(14, 226, 28) // "on_pushButton_apply_released"

    },
    "FieldSelectionDialog\0setMaskCoordinates\0"
    "\0QVector<QList<QPoint> >\0"
    "setTrapeziumCoordinates\0processMouse\0"
...
void FieldSelectionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setTrapeziumCoordinates((*reinterpret_cast< QVector<QList<QPoint> >(*)>(_a[1]))); break;
        case 2: _t->processMouse((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 3: _t->processClick((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 4: _t->setFrame((*reinterpret_cast< QVector<QImage>(*)>(_a[1]))); break;
        case 5: _t->on_cameraSelectCombo_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->on_pushButton_set_released(); break;
        case 7: _t->on_pushButton_apply_released(); break;
        default: ;
        }
        ...
        {
            typedef void (FieldSelectionDialog::*_t)(QVector<QList<QPoint> > );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FieldSelectionDialog::setTrapeziumCoordinates)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 1
void FieldSelectionDialog::setTrapeziumCoordinates(QVector<QList<QPoint> > _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
