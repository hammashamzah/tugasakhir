...
QT_MOC_LITERAL(7, 116, 18), // "getTransformMatrix"
QT_MOC_LITERAL(8, 135, 10), // "QList<Mat>"
QT_MOC_LITERAL(9, 146, 12), // "getImageSize"
QT_MOC_LITERAL(10, 159, 12), // "QList<QSize>"
QT_MOC_LITERAL(11, 172, 24), // "processTransformPosition"
QT_MOC_LITERAL(12, 197, 15) // "QVector<QPoint>"
    ...
    "processTransformPosition\0QVector<QPoint>"
};
...
void CoordinateTransform::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->getTransformMatrix((*reinterpret_cast< QList<Mat>(*)>(_a[1]))); break;
        case 4: _t->getImageSize((*reinterpret_cast< QList<QSize>(*)>(_a[1]))); break;
        case 5: _t->processTransformPosition((*reinterpret_cast< QVector<QPoint>(*)>(_a[1]))); break;
        default: ;
        }
