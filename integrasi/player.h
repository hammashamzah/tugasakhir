...
public:
    //constructor
    Player();
    Player(int frame, int cameraId, Point2f cameraPosition);
    Player(int identity, int cameraId, int frame, Point2f inputPosition, Point2f inputSpeed, Point2f inputAcceleration, Point2f inputCameraPos);
