...
public:
    ...
    void setupUi(QDialog *DistortionCorrectionDialog)
    {
        ...
        imageView = new ClickDisplay(DistortionCorrectionDialog);
        imageView->setObjectName(QStringLiteral("imageView"));
        imageView->setMinimumSize(QSize(600, 400));
        imageView->setFrameShape(QFrame::Panel);
    ...
    void retranslateUi(QDialog *DistortionCorrectionDialog)
    {
        ...
        imageView->setText(QApplication::translate("DistortionCorrectionDialog", "TextLabel", 0));
