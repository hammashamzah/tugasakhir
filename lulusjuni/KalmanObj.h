...
class Kalmanobj{
    ...
    private:
        ...
        void track_size(double &pred_w, double &pred_h,Node* init_matric,Node* curr_matric);
        void track_ind2Dmotion(Node* curr_cond, Point pre_pos,Point pre_veloc,Point pre_Acce,Point post_pos,Point post_veloc,Point post_Acce);
        void track_ind3Dmotion(Node* curr_cond, Point pre_pos,Point pre_veloc,Point pre_Acce,Point post_pos,Point post_veloc,Point post_Acce);
        int Object_Number;
        int camera;
        int frame_start;
        KalmanFilter KF_Mot;
