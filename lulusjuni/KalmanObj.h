...
class Kalmanobj{
    public:
        ...
        void multitrackObj(bool IsInit,struct Node* init_symp, struct Node* current_symp, struct Node** predict_track,Point accel_3d[],Point velo3d[],Point accels[],Point velo[]);
    private:
