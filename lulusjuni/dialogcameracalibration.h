...
private slots:
    ...
    void on_pushButton_runCalibration_clicked();
...
public:
    ...
    enum Pattern { NOT_EXISTING, CHESSBOARD, CIRCLES_GRID, ASYMMETRIC_CIRCLES_GRID };   //enumerasi pettern
    enum InputType {INVALID, CAMERA, VIDEO_FILE, IMAGE_LIST};                           //enumerasi kemungkinan input
...
extern void CameraCalibrationProcess();
