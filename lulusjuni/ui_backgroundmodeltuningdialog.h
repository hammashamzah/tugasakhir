...
public:
    ...
    QLabel *label_97;
    QSlider *slider_min_area_3;
    QLabel *label_98;
    QCheckBox *checkBox_11;
    QLabel *label_99;
    QHBoxLayout *horizontalLayout_41;
    QLabel *label_100;
    QSlider *slider_max_area_3;
    QLabel *label_101;
    QCheckBox *checkBox_12;
    QLabel *label_102;
    QHBoxLayout *horizontalLayout_42;
    QLabel *label_103;
    QSlider *slider_morp_element_size_3;
    QLabel *label_104;
    QCheckBox *checkBox_13;
    QLabel *label_105;
    QHBoxLayout *horizontalLayout_43;
    QLabel *label_106;
    QSlider *slider_gaussian_size_3;
    QLabel *label_107;
    ...
    void setupUi(QDialog *BackgroundModelTuningDialog)
    {
        ...
        BackgroundModelTuningDialog->resize(932, 462);
        ...
        groupBox_3 = new QGroupBox(BackgroundModelTuningDialog);
        ...
        label_96->setMinimumSize(QSize(0, 10));

        verticalLayout_19->addWidget(label_96);
        ...
        horizontalLayout_40->addWidget(label_97);

        slider_min_area_3 = new QSlider(groupBox_3);
        slider_min_area_3->setObjectName(QStringLiteral("slider_min_area_3"));
        sizePolicy1.setHeightForWidth(slider_min_area_3->sizePolicy().hasHeightForWidth());
        slider_min_area_3->setSizePolicy(sizePolicy1);
        slider_min_area_3->setMaximum(300);
        slider_min_area_3->setOrientation(Qt::Horizontal);

        horizontalLayout_40->addWidget(slider_min_area_3);

        label_98 = new QLabel(groupBox_3);
        label_98->setObjectName(QStringLiteral("label_98"));

        horizontalLayout_40->addWidget(label_98);
        ...
        verticalLayout_19->addWidget(checkBox_11);
        ...
        label_99->setMinimumSize(QSize(0, 10));

        verticalLayout_19->addWidget(label_99);
        ...
        horizontalLayout_41->addWidget(label_100);

        slider_max_area_3 = new QSlider(groupBox_3);
        slider_max_area_3->setObjectName(QStringLiteral("slider_max_area_3"));
        sizePolicy1.setHeightForWidth(slider_max_area_3->sizePolicy().hasHeightForWidth());
        slider_max_area_3->setSizePolicy(sizePolicy1);
        slider_max_area_3->setMinimum(100);
        slider_max_area_3->setMaximum(1000);
        slider_max_area_3->setOrientation(Qt::Horizontal);

        horizontalLayout_41->addWidget(slider_max_area_3);
        ...
        verticalLayout_19->addWidget(checkBox_12);
        ...
        label_102->setMinimumSize(QSize(0, 10));

        verticalLayout_19->addWidget(label_102);
        ...
        horizontalLayout_42->addWidget(label_103);

        slider_morp_element_size_3 = new QSlider(groupBox_3);
        slider_morp_element_size_3->setObjectName(QStringLiteral("slider_morp_element_size_3"));
        sizePolicy1.setHeightForWidth(slider_morp_element_size_3->sizePolicy().hasHeightForWidth());
        slider_morp_element_size_3->setSizePolicy(sizePolicy1);
        slider_morp_element_size_3->setMinimum(3);
        slider_morp_element_size_3->setMaximum(11);
        slider_morp_element_size_3->setSingleStep(2);
        slider_morp_element_size_3->setPageStep(2);
        slider_morp_element_size_3->setOrientation(Qt::Horizontal);
        slider_morp_element_size_3->setInvertedAppearance(false);
        slider_morp_element_size_3->setInvertedControls(false);
        slider_morp_element_size_3->setTickPosition(QSlider::TicksBelow);
        slider_morp_element_size_3->setTickInterval(2);

        horizontalLayout_42->addWidget(slider_morp_element_size_3);

        label_104 = new QLabel(groupBox_3);
        label_104->setObjectName(QStringLiteral("label_104"));

        horizontalLayout_42->addWidget(label_104);
        ...
        verticalLayout_19->addWidget(checkBox_13);

        label_105 = new QLabel(groupBox_3);
        label_105->setObjectName(QStringLiteral("label_105"));
        sizePolicy1.setHeightForWidth(label_105->sizePolicy().hasHeightForWidth());
        label_105->setSizePolicy(sizePolicy1);
        label_105->setMinimumSize(QSize(0, 10));

        verticalLayout_19->addWidget(label_105);

        horizontalLayout_43 = new QHBoxLayout();
        horizontalLayout_43->setObjectName(QStringLiteral("horizontalLayout_43"));
        label_106 = new QLabel(groupBox_3);
        label_106->setObjectName(QStringLiteral("label_106"));

        horizontalLayout_43->addWidget(label_106);

        slider_gaussian_size_3 = new QSlider(groupBox_3);
        slider_gaussian_size_3->setObjectName(QStringLiteral("slider_gaussian_size_3"));
        sizePolicy1.setHeightForWidth(slider_gaussian_size_3->sizePolicy().hasHeightForWidth());
        slider_gaussian_size_3->setSizePolicy(sizePolicy1);
        slider_gaussian_size_3->setMinimum(3);
        slider_gaussian_size_3->setMaximum(15);
        slider_gaussian_size_3->setOrientation(Qt::Horizontal);
        slider_gaussian_size_3->setTickPosition(QSlider::TicksBelow);
        slider_gaussian_size_3->setTickInterval(1);

        horizontalLayout_43->addWidget(slider_gaussian_size_3);

        label_107 = new QLabel(groupBox_3);
        label_107->setObjectName(QStringLiteral("label_107"));

        horizontalLayout_43->addWidget(label_107);
    ...
    void retranslateUi(QDialog *BackgroundModelTuningDialog)
    {
        ...
        groupBox_3->setTitle(QApplication::translate("BackgroundModelTuningDialog", "Parameter Tuning - Camera 3", 0));
        label_96->setText(QApplication::translate("BackgroundModelTuningDialog", "Blob Detector Min Area", 0));
        label_97->setText(QApplication::translate("BackgroundModelTuningDialog", "0", 0));
        label_98->setText(QApplication::translate("BackgroundModelTuningDialog", "300", 0));
        checkBox_11->setText(QApplication::translate("BackgroundModelTuningDialog", "Enable Blob Detector Max Area", 0));
        label_99->setText(QApplication::translate("BackgroundModelTuningDialog", "Blob Detector Max Area", 0));
        label_100->setText(QApplication::translate("BackgroundModelTuningDialog", "100", 0));
        label_101->setText(QApplication::translate("BackgroundModelTuningDialog", "1000", 0));
        checkBox_12->setText(QApplication::translate("BackgroundModelTuningDialog", "Enable Morphology Opening", 0));
        label_102->setText(QApplication::translate("BackgroundModelTuningDialog", "Morphology Structuring Element Size", 0));
        label_103->setText(QApplication::translate("BackgroundModelTuningDialog", "3", 0));
        label_104->setText(QApplication::translate("BackgroundModelTuningDialog", "11", 0));
        checkBox_13->setText(QApplication::translate("BackgroundModelTuningDialog", "Enable Gaussian Blur", 0));
        label_105->setText(QApplication::translate("BackgroundModelTuningDialog", "Gaussian Blur Size of Filter", 0));
        label_106->setText(QApplication::translate("BackgroundModelTuningDialog", "3", 0));
        label_107->setText(QApplication::translate("BackgroundModelTuningDialog", "15", 0));
