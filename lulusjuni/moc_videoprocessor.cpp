...
QT_MOC_LITERAL(1, 15, 8), // "rawImage"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5), // "image"
QT_MOC_LITERAL(4, 31, 18), // "updateValueMinArea"
QT_MOC_LITERAL(5, 50, 5), // "value"
QT_MOC_LITERAL(6, 56, 18), // "updateValueMaxArea"
QT_MOC_LITERAL(7, 75, 27), // "updateValueMorphElementSize"
QT_MOC_LITERAL(8, 103, 23) // "updateValueGaussianSize"

    },
    "VideoProcessor\0rawImage\0\0image\0"
    "updateValueMinArea\0value\0updateValueMaxArea\0"
    "updateValueMorphElementSize\0"
    "updateValueGaussianSize"
};
...
void VideoProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rawImage((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        case 1: _t->updateValueMinArea((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->updateValueMaxArea((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->updateValueMorphElementSize((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->updateValueGaussianSize((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (VideoProcessor::*_t)(const QImage & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoProcessor::rawImage)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void VideoProcessor::rawImage(const QImage & _t1)
{
