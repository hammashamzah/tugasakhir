...
QT_MOC_LITERAL(4, 38, 17), // "sendClickPosition"
QT_MOC_LITERAL(5, 56, 22) // "sendRightClickPosition"
...
void matDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (matDisplay::*_t)(QPoint & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&matDisplay::sendClickPosition)) {
                *result = 1;
            }
        }
        {
            typedef void (matDisplay::*_t)(QPoint & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&matDisplay::sendRightClickPosition)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject matDisplay::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_matDisplay.data,
      qt_meta_data_matDisplay,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 1
void matDisplay::sendClickPosition(QPoint & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void matDisplay::sendRightClickPosition(QPoint & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
